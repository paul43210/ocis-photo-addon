...
describe('usePhotos', () => {
  ...
  describe('isImage', () => {
    it('should identify jpg files as images', () => {
      ...
      expect(isImage({ id: '3', name: 'photo.JPG' })).toBe(true)
    })

    it('should identify png files as images', () => {
      expect(isImage({ id: '1', name: 'image.png' })).toBe(true)
      expect(isImage({ id: '2', name: 'image.PNG' })).toBe(true)
    })

    it('should identify other image formats', () => {
      expect(isImage({ id: '1', name: 'photo.gif' })).toBe(true)
      expect(isImage({ id: '2', name: 'photo.webp' })).toBe(true)
      expect(isImage({ id: '3', name: 'photo.heic' })).toBe(true)
      expect(isImage({ id: '4', name: 'photo.heif' })).toBe(true)
      expect(isImage({ id: '5', name: 'photo.tiff' })).toBe(true)
      expect(isImage({ id: '6', name: 'photo.tif' })).toBe(true)
    })
    ...
    it('should identify files by MIME type', () => {
      ...
      expect(isImage({ id: '3', name: 'file', mimeType: 'image/gif' })).toBe(true)
      expect(isImage({ id: '4', name: 'file', mimeType: 'image/webp' })).toBe(true)
    })
    ...
    it('should reject non-image files', () => {
      ...
      expect(isImage({ id: '4', name: 'data.json' })).toBe(false)
      expect(isImage({ id: '5', name: 'config.xml' })).toBe(false)
    })

    it('should reject SVG and icon files', () => {
      expect(isImage({ id: '1', name: 'icon.svg', mimeType: 'image/svg+xml' })).toBe(false)
      expect(isImage({ id: '2', name: 'logo.svg', mimeType: 'image/svg+xml' })).toBe(false)
      expect(isImage({ id: '3', name: 'favicon.ico', mimeType: 'image/x-icon' })).toBe(false)
    })

    it('should reject sidecar/metadata files with image-like names', () => {
      expect(isImage({ id: '1', name: 'photo.jpg.json' })).toBe(false)
      expect(isImage({ id: '2', name: 'image.xml' })).toBe(false)
      expect(isImage({ id: '3', name: 'metadata.txt' })).toBe(false)
    })
  })
  ...
  describe('filterImages', () => {
    ...
    it('should exclude folders by isFolder property', () => {
      const files = [
        { id: '1', name: 'Photos', isFolder: true },
        { id: '2', name: 'photo.jpg' },
      ]
  ...
  describe('getDateKey', () => {
    it('should format date as YYYY-MM-DD for day mode', () => {
      ...
      const file = { id: '1', name: 'photo.jpg', mdate: date.getTime() }
  ...
  describe('groupByDate', () => {
    it('should group photos by date', () => {
      ...
      const photos = [
        { id: '1', name: 'a.jpg', mdate: new Date(2026, 0, 10, 12, 0, 0).getTime() },
        { id: '2', name: 'b.jpg', mdate: new Date(2026, 0, 10, 14, 0, 0).getTime() },
        { id: '3', name: 'c.jpg', mdate: new Date(2026, 0, 9, 12, 0, 0).getTime() },
      ]
    ...
    it('should sort groups newest first', () => {
      const photos = [
        { id: '1', name: 'a.jpg', mdate: new Date(2026, 0, 8, 12, 0, 0).getTime() },
        { id: '2', name: 'b.jpg', mdate: new Date(2026, 0, 10, 12, 0, 0).getTime() },
        { id: '3', name: 'c.jpg', mdate: new Date(2026, 0, 9, 12, 0, 0).getTime() },
      ]
    ...
    it('should group by month when mode is month', () => {
      const photos = [
        { id: '1', name: 'a.jpg', mdate: new Date(2026, 0, 5, 12, 0, 0).getTime() },
        { id: '2', name: 'b.jpg', mdate: new Date(2026, 0, 25, 12, 0, 0).getTime() },
        { id: '3', name: 'c.jpg', mdate: new Date(2026, 1, 10, 12, 0, 0).getTime() },
      ]
    ...
    it('should group by year when mode is year', () => {
      const photos = [
        { id: '1', name: 'a.jpg', mdate: new Date(2026, 0, 5, 12, 0, 0).getTime() },
        { id: '2', name: 'b.jpg', mdate: new Date(2026, 11, 25, 12, 0, 0).getTime() },
        { id: '3', name: 'c.jpg', mdate: new Date(2025, 5, 10, 12, 0, 0).getTime() },
      ]
  ...
  describe('getPhotoDate', () => {
    ...
    it('should return current date as last resort', () => {
      const file = { id: '1', name: 'photo.jpg' }
      const date = getPhotoDate(file)
      const now = new Date()
